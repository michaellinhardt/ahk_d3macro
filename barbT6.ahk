...
Macro:
	...
	pZ := fastPixelGetColor(699, 1112) ; 1580056 = UP
	pZMid := fastPixelGetColor(731, 1173) ; - != PAS UP
	pE := fastPixelGetColor(773, 1112) ; 1448470 = UP ALLIE MYSTIQUE
	pR := fastPixelGetColor(847, 1112) ; - = UP EPIPHANIE
	
	pBattleRage := fastPixelGetColor(1545, 1090) ; 8224199 = ESPRIT >200
	
	pZerk := fastPixelGetColor(1594, 1088) ; 8224199 = ESPRIT >200
	
	;msgbox pCD = %pCD% pCG = %pCG% pa = %pA% pZ = %pZ% pZMid = %pZMid% pE = %pE% pR = %pR%
	;msgbox  pZ = %pZ% pE = %pE% pBattleRage = %pBattleRage%  
